...
return [
    ...
    */
    ...
    'ttl' => (int) env('JWT_ACCESS_TOKEN_TTL', 60),
    ...
    |--------------------------------------------------------------------------
    |
    | TTL aplicado individualmente a cada token emitido pelo par (login/refresh).
    | O access é curto; o refresh é longo e sustenta o "manter conectado".
    | "refresh_token_ttl" também define por quanto tempo um "sid" revogado
    | (logout/rotação) permanece na blacklist de sessão em cache.
    |
    */

    'access_token_ttl' => (int) env('JWT_ACCESS_TOKEN_TTL', 60),

    'refresh_token_ttl' => (int) env('JWT_REFRESH_TOKEN_TTL', 20160), // 14 dias
